        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryTitle = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    ParentCategoriesId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => new { x.PostId, x.Id });
                    table.ForeignKey(
